...
- `LiveOnPlugin`: registra e remove componentes e encaminha eventos.
...
SQLite atende a primeira fase. Para PostgreSQL, mantenha as mesmas funções
públicas de `Database` ou crie uma implementação equivalente; o plugin não muda.
